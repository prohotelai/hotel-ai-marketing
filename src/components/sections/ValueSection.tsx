...
// Value Section component - Enterprise-grade visual presentation
...
export function ValueSection({ translationPrefix, cards, bgColor = 'bg-white' }: ValueSectionProps) {
    ...
    <section className={`py-24 ${bgColor}`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {cards.map((card) => {
            const iconKey = t(`${translationPrefix}.cards.${card.key}.icon`);
            const icon = iconMap[iconKey] || iconMap['chart-bar'];
            ...
            return (
              ...
              >
                ...
                <h3 className="text-lg font-semibold text-gray-900 mb-4 leading-snug">
                  {t(`${translationPrefix}.cards.${card.key}.title`)}
                </h3>
                <p className="text-gray-600 text-sm leading-relaxed">
                  {t(`${translationPrefix}.cards.${card.key}.description`)}
                </p>
              </div>
            );
          })}
